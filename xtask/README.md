...
Usage: xtask build <COMMAND>

Commands:
  examples  Build all examples for the specified chip
  package   Build the specified package with the given options
  tests     Build all applicable tests or the specified test for a specified chip
  help      Print this message or the help of the given subcommand(s)
```
...
Usage: xtask run <COMMAND>

Commands:
  example  Run the given example for the specified chip
  tests    Run all applicable tests or the specified test for a specified chip
  help     Print this message or the help of the given subcommand(s)
```
